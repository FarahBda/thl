...
document.getElementById("button-exo1-p1").addEventListener("click", function () {
    ...
    if (checkCharacters(word) || word == "") {
        ...
        document.getElementById("result-exo1").innerHTML = "Ce mot ne fait pas partie du langage";
    }
});
...
document.getElementById("button-exo1-p2").addEventListener("click", function () {
    ...
    // if no, return "this word is not from the language"
    if (isNaN(n)) {
        document.getElementById("puissance").innerHTML = "Entrez un nombre positif";
    } else {
        ...
        if (checkCharacters(word) || word == "") {
            ...
            document.getElementById("puissance").innerHTML = "Ce mot ne fait pas partie du langage";
        }
    }
});
